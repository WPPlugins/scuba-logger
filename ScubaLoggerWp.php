...
class ScubaLoggerWp {
	...
	public function check_temp_unit($input) {
		if (strcmp(strtolower($input), 'celsius') == 0 || strcmp(strtolower($input), 'farenheit') == 0) {
			return $input;
		}
		return 'Celsius';
	}
	...
	public function display_options_page() {
		...
		<select name="temp_units">
			...
			<option value="Farenheit" <?php if (strcmp(get_option('temp_units'),'Farenheit') == 0) { echo 'selected';} ?> >Farenheit</option>
		</select>
		</td>
        </tr>
   		</table>
